...
src/
  ...
  recourse.py                  counterfactual recourse ("what to change to get approved")
  viz_style.py                 shared chart palette/style
app/streamlit_app.py           decision-support app: score + SHAP + recourse + fairness note
tests/                         pytest suite (43 tests, ~99% coverage; enforced >=80% via pytest.ini)
